    ...
    <section id="home" className="relative flex min-h-[70vh] items-center bg-transparent pt-28 pb-16">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl gap-12 px-6 md:grid-cols-[1.1fr_1fr] md:items-center">
        ...
        >
          ...
          <h1 style={{ fontFamily: "var(--font-pixel), var(--font-sans)" }} className="text-4xl font-bold leading-[1.05] tracking-tighter text-white md:text-5xl lg:text-6xl">
          ...
          <div className="mt-6 flex items-center gap-4">
            <a href="https://github.com/" target="_blank" rel="noreferrer" aria-label="GitHub" className="text-slate-200 hover:text-[#38bdf8] transition transform hover:scale-110 duration-200">
            ...
            <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="text-slate-200 hover:text-[#38bdf8] transition transform hover:scale-110 duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-8 w-8">
